...
def login(request):
    ...
    context = {
        ...
        # 11) IS_VALID() olduqda İF içində nə baş versin dedik. Bəs əgər İstifadəçi, INPUT sahəsində VALİD olmuyan dəyərlər yazarsa onda nə baş verəcək? Yuxarıda    'if form.is_valid()'   yazısının üstündəki FORM variable-ı input sahəsinə
        #     yazılan dəyərləri götürür. Həmçinin xətalı girilən dəyərlər. Bu dəyərlər ötürülür bu hal-hazırda olduğumuz yerin bir sətr altındakı  'form' : form   adlı xassəyə ordan da şablona və xətalı girilən dəyər haqqında məlumatıda 
        #     şablonda əks etdirə bilirik. Xəta mesajlarının göstərilməsini hələki düzəltməmişik ancaq birazdan edəcəyik. Hələki proqramı işə salaq və nə əldə edəcəyimizə baxaq. 
        'form' : form
    }
    return render( request, 'users/login.html', context )

    # 12) NOT. Veb sehifeye kecid etdikden sonra INPUT sahesine deyer daxil edib BUTTON klikledikde   Forbidden (403) CSRF verification failed.     deyə bir xəta mesajı alacağıq. 
