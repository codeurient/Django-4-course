...
class Categories(models.Model):
    ...
    class Meta:
        ...
        # 1) ORDERING adlı bir xasse yaradırıq. Bu xassə ya LİST [],   yaxud   TUPLE () qəbul edir.  Biz tuple edək.
        # 2) Sonra tuple içində sıralanmanı hansı sahəyə görə etmək istədiyimizi deməliyik. Məsələn İD.  Sonra proqramı işə salırıq və səhifəni yeniləyirik. Artır terminalda həmin xəbərdarlıq mesajı olmayacaq.
        ordering = ("id", )
