...
def catalog(request):
    # 1) CATALOG.HTML sehifesinde gostermek ucun muveqqeti melumatlar bazasi yaradiriq. Bu melumatlar eslinde verilenler bazasindan gelmelidir ancaq heleki burda manual yaradiriq hemin bazani.
    context = {
        "title": "Home - Catalog",
        "goods": [
            {
    ...
    return render(request, "goods/catalog.html", context)  # 2) DICT icinde yerlesen melumatlari gonderirik CATALOG.HTML faylina. 
